...
public class StringLecture {
    ...
    public static void main(String[] args) {
        ...
        //**primitive types are stored as that specific value in memory while strings are not
        //** an object is the most generic type in java
        //** empty objects only contain their unique reference id
        // ex: Object o1 = new Object();
        //**double quotes automatically creates a new object
...
//        System.out.println(isADoctor);
        ...
        //** so far, strings are immutable. methods return a copy of the object
...
//          // charAt saves characters as characters and not strings
            //String firstLetter = String.valueOf(word.charAt(0)); takes the value of a character and
            //converts it to a string
            // vice versa, Character firstLetter = Character.toUppercase(word.charAt(0));
